...
with open('D:\Development of Baby monitor device for bby cry detection\Baby-Monitor-Device-for-Baby-Cry-Detection\Baby Cry Detection\ModelWeights\cnn.json', 'r') as f:
    mymodel = model_from_json(f.read())

mymodel.load_weights(
    "D:\Development of Baby monitor device for bby cry detection\Baby-Monitor-Device-for-Baby-Cry-Detection\Baby Cry Detection\ModelWeights\cnn.h5")
